...
deleteOrBackspacePressed: (Keys -> KeyState) -> Bool
deleteOrBackspacePressed keyInfo = 
  keyInfo Delete == JustDown || keyInfo Delete == Down || 
  keyInfo Backspace == JustDown || keyInfo Backspace == Down
